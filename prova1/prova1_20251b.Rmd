...
a. ( \hspace{0,5cm} ) Metade dos valores de uma variável quantitativa são sempre menores que a mediana.

b. ( \hspace{0,5cm} ) Quando a variável quantitativa tem distribuição unimodal e assimétrica, metade de seus valores é menor que a média.

c. ( \hspace{0,5cm} ) A mediana não é uma boa medida de tendência central para uma variável quantitativa com distribuição unimodal muito assimétrica, pois esta medida é muito influenciada por valores extremos.

d. ( \hspace{0,5cm} ) A média é quem melhor representa um conjunto de dados, pois ela é a única medida de tendência central que leva em consideração todas as observações existentes.

e. ( \hspace{0,5cm} ) Se a média e a mediana de um conjunto de dados forem respectivamente 10 e 15 pode-se dizer que essa distribuição não apresenta assimetria.

<!-- f. ( \hspace{0,5cm} ) Quanto menor a média, menor é a variância. -->

f. ( \hspace{0,5cm} ) Quanto maior é a variância, menor é o desvio padrão.

g. ( \hspace{0,5cm} ) O coeficiente de variação é uma medida na mesma unidade de medida da variável original.
...
a. Quais as variáveis analisadas? Classifique-as. Qual é a unidade de observação? 

b. Utilizando os gráficos de boxplot da figura 1 responda verdadeiro (V) ou falso (F):

( \hspace{0,5cm} ) Os respondentes do sexo masculino tiveram preferências semelhantes entre economia e esportes.

( \hspace{0,5cm} ) No assunto economia, as medianas enre homens e mulheres não são equivalentes.

( \hspace{0,5cm} ) Os homens tenderam a informar um escore de interesse similar ao das mulheres em todos os assuntos.

( \hspace{0,5cm} ) Os escores no assunto política apresentam distribuições assimétricas.
...
de $30\%$. A empresa quer saber a probabilidade de 5 indivíduoss em um grupo de 10 pessoas, que possuem renda de 20.000 a 30.000, passarem por auditoria.
...
**Questão 5.** Uma pequena companhia de seguros analisou a frequência com que todos os seus segurados utilizaram serviços hospitalares durante um certo período. Os 
...
a. Qual a probabilidade de ser um homem e que não tenha utilizado serviços hospitalares?

b. Qual a probabilidade de ser mulher ou tenha utilizado serviços hospitalares?

c. Sabendo que o segurado é homem, qual a probabilidade de este ter usado serviços hospitalares?

d. Qual a probabilidade de ser homem dado que o segurado não usou serviços hospitalares?
